...
$(function(){$(".main-form").submit(function(){var t=$(this);return $.ajax({type:"POST",url:"/mail.php",data:t.serialize()}).done(function(){$(".success").fadeIn().css("display","flex"),setTimeout(function(){$(".success").fadeOut(),t.trigger("reset")},3e3)}),!1}),jQuery(".logo_svg").each(function(){var t=jQuery(this),e=t.attr("id"),a=t.attr("class"),r=t.attr("src");jQuery.get(r,function(r){var s=jQuery(r).find("svg");void 0!==e&&(s=s.attr("id",e)),void 0!==a&&(s=s.attr("class",a+" replaced-svg")),s=s.removeAttr("xmlns:a"),!s.attr("viewBox")&&s.attr("height")&&s.attr("width")&&s.attr("viewBox","0 0 "+s.attr("height")+" "+s.attr("width")),t.replaceWith(s)},"xml")}),$(".owl-carousel").owlCarousel({items:1,loop:!0,autoplay:3e3,autoplayHoverPause:!1,smartSpeed:2e3,rewindSpeed:9e3,mouseDrag:!1}),$(".owl-carousel ").owlCarousel({items:3}),$(".customers li").equalHeight()});